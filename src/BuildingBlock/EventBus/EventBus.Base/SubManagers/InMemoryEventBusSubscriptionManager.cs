...
namespace EventBus.Base.SubManagers
{
    public class InMemoryEventBusSubscriptionManager : IEventBusSubscriptionManager
    {
        ...
        public event EventHandler<string> OnEventRemover;
        ...
        private void AddSubscription(Type handlerType, string eventName)
        {
            ...
            _handlers[eventName].Add(SubscriptionInfo.Type(handlerType));
        }
        ...
        {
            var eventName = GetEventKey<T>();
            return FindSubscriptionToRemove( typeof(TH), eventName);
        }

        private SubscriptionInfo FindSubscriptionToRemove(Type handlerType, string eventName)
        {
            if (!HasSubscriptionForEvent(eventName))
                return null;
